...
namespace Source_MFC.Global
{
    ...
    public class TASKARG
    {
        ...
        public eSUBSEQLIST errSubTsk = eSUBSEQLIST.MAX_SUB_SEQ;        
        ...
        public void Init()
        {
            ...
            this.nStuff = 0;
            this.tWrk.nStart = 0;
            this.errSubTsk = eSUBSEQLIST.MAX_SUB_SEQ;
            ResetTime();
        }
        ...
        public void SetErr(eERROR err, eSUBSEQLIST tsk = eSUBSEQLIST.MAX_SUB_SEQ)
        {
            switch (this.nErr)
            {
                case eERROR.None:
